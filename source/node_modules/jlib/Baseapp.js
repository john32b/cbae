...
var APP = {
	...
	IP : {
		...
		require:{
			...
			multi:true,		// Supports multiple inputs | Basic globbing {*} {*.ext} | Changes usage string in -help
		},

		help: {
			info:null,				// String[], Text under the banner
			usage:null,				// Text at the usage screen. Supports TAGS | Reminder <n> newline <t> tab
	...
	_readArguments() 
	{
		...
		while ((arg = process.argv[cc++]) != null) 
		{
			...
			if (arg.charAt(0) === "-") {
				...
				if (arg == "help" || arg=="-help") return "HELP"; // Force of habit to write --help
				let o = P.options[arg];
	 ...
	 * @param {Object} userParams Override APP.IP fields. Check in code
	 * @param {String} userParams.name
	 * @param {String} userParams.ver
	 * @param {String} userParams.desc
	 * @param {Object} userParams.actions
	 * @param {Object} userParams.options
	 * @param {Object} userParams.require
	 * @param {Object} userParams.help
	 */
	init(userParams) 
	{
